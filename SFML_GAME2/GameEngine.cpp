...
void Game::render()
{
	...
	if (this->menu->menuSelector == Pause || this->menu->menuSelector == GameOver || this->menu->menuSelector == WinLevel || this->menu->menuSelector == Shop || this->menu->menuSelector == Main || this->menu->menuSelector == Levels || this->menu->menuSelector == Controls  )
	{
